...
mysql_select_db($database_proyecto, $proyecto);
$query_monumento = "SELECT * FROM monumentos where idMonumentos= $id";
mysql_query("SET NAMES 'utf8'");
    ...
    <div class="content">
        <div class="post">
            ...
            <?php if($totalRows_monumento>0){
				...
				<div class="post-item">
						Titulo: <input type="text" name="titulo" id="titulo"  width="200px" value=" "/>
				...
				<div class="post-item">
							...
							<table>
								<tr>
									<td>Español</td> 
									<td><input type="radio" name="idioma" value="2" checked="checked"/></td>
								
									<td>Ingles</td> <td><input type="radio" name="idioma" value="1" /></td>
									<td>Chino</td> <td><input type="radio" name="idioma" value="3" /></td>
								</tr>
							</table>
					</div>
